...
- [x] Functional three-tier sorting pipeline
- [x] Reliable background daemon via systemd
- [x] Atomic file moves with collision avoidance
- [x] CLI for management and review
...
**Gaps to Close:**
- [x] Fix review interactive prompt output logic
- [x] Fix log retrieving decision history properly
